...
export const constantRouterMap = [
  ...
  //       component: () => import('@/views/modules/businessProject/FinanceCashOutList')
  //     },
  //     {
  //       path: 'platform',
  //       name: 'PlatformFinanceList',
  //       component: () => import('@/views/modules/businessProject/PlatformFinanceList')
  //     },
  //     {
  //       path: 'stock',
  //       name: 'UserAgentGoodsInventoryList',
  //       component: () => import('@/views/modules/businessProject/UserAgentGoodsInventoryList')
  //     },
  //   ]
  // },
  // {
  ...
  //       component: () => import('@/views/modules/businessProject/UserCustomerList')
  //     },
  //     {
  //       path: 'demo',
  //       name: 'UserFinanceList',
  //       component: () => import('@/views/modules/businessProject/UserFinanceList')
  //     },
  //     {
  //       path: 'login',
  //       name: 'UserLoginInfoList',
  //       component: () => import('@/views/modules/businessProject/UserLoginInfoList')
  //     },
  //     {
  //       path: 'refer',
  //       name: 'UserReferralInfoList',
  //       component: () => import('@/views/modules/businessProject/UserReferralInfoList')
  //     },
  //     {
  //       path: 'region',
  //       name: 'UserRegionAgentList',
  //       component: () => import('@/views/modules/businessProject/UserRegionAgentList')
  //     },
  //   ]
  // },
  {
