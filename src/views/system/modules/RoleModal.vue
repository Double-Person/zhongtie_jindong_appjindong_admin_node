    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
            ...
            :wrapperCol="wrapperCol"
            label="系统类型">
            <a-radio-group v-decorator="[ 'sysType', validatorRules.sysType]">
              <a-radio v-for="(item, key) in $store.getters.sysType" :key="key" :value="item.value">{{ item.label }}</a-radio>
            </a-radio-group>
        </a-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'roleName', 'sysType', 'description','roleCode'))
        });
